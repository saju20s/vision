                    ...
                    <div class="col-md-12 column-twelve">
                        ...
                        <div class="text-center m-0 bg-white py-3 position-relative">
                            ...
                            <h4 class="fw-bold mb-1">
                                {{ $patient->name }}
                                <span class="btn btn-sm btn-primary ms-2">ID: {{ $patient->id }}</span>
                            </h4>
                        ...
                        <div class="table-responsive" id="printArea">
                            <table class="table table-hover align-middle">
                                ...
                                @if ($bills->count())
                                    @php
                                        $totalDiscount = $bills->sum(function ($bill) {
                                            if ($bill->discount_type === 'percentage') {
                                                // Percentage discount reverse calculate
                                        ...
                                        $grossTotal = $bills->sum('total_amount') + $totalDiscount;
                                    @endphp
    ...
    function printDiv(divId) {
        ...
        var doctorInfo = `
            <h3 style="text-align:center; margin:0px;">
                Dr. {{ $patient->name }}
                <small style="font-size:14px; color:#000;">(ID: {{ $patient->id }})</small>
            </h3>
            <p style="text-align:center; margin:0;"><strong>Phone:</strong> {{ $patient->phone }}</p>
