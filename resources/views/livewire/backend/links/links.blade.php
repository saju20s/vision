                        ...
                        <div class="table-responsive table-show">
                            <table class="table table-hover align-middle">
                                <div class="table-add text-end d-flex justify-content-between align-items-center">
                                    ...
                                    @can('links.add')
                                        <a href="/add-link" class="btn btn-md btn-primary my-3" wire:navigate><i class="fa-solid fa-plus"></i> Add New</a>
                                    @endcan
                                </div>
                                ...
                                <tbody>
                                    ...
                                    @forelse($datas as $index => $data)
                                        <tr wire:loading.remove>
                                            ...
                                            <td>{{ $data->title }}</td>
                                            <td>{{ $data->link }}</td>
                                            <td><span class="badge bg-success">{{ ucfirst($data->position) }}</span>
                                            </td>
