                                ...
                                <tbody>
                                        ...
                                        <td colspan="7">
                                            <div
                                                ...
                                                <div class="text-center">
                                                    ...
                                                    <span class="text-muted">Loading investigations...</span>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    @forelse($datas as $index => $data)
                                        <tr wire:loading.remove>
                                            ...
                                            <td>
                                                @can('investigation_form.edit')
                                                    <a href="{{ route('testform.edit', $data->id) }}"
                                                        class="btn btn-sm bg-success-light mr-2" wire:navigate>
                                                        <i class="fa-solid fa-pencil"></i> Edit Test Form
                                                    </a>
                                                @endcan
                                            </td>
                                        </tr>
