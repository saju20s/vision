                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-4 mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="authority" wire:model.defer="authority" placeholder="Authority"
                                            class="form-control" />                                        
                                    </div>
                                    ...
                                    @if ($existingImage)
                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">Old Image /PDF</label><br>
                                            @if ($existingImage)
                                                <img class="img-fluid rounded shadow image-preview" alt="Preview"
                                                    src="{{ asset('storage/' . $existingImage) }}" loading="lazy">
                                            @else
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <label for="file" class="form-label fw-semibold">File Image /
                                            PDF</label>
