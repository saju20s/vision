                        ...
                        <div class="table-responsive table-show">
                            <table class="table table-hover align-middle ">
                                <div class="table-add text-end d-flex justify-content-between align-items-center">
                                    ...
                                    @can('noc.add')
                                        <a href="/add-notice" class="btn btn-md btn-primary my-3" wire:navigate><i class="fa-solid fa-plus"></i> Add New</a>
                                    @endcan
                                </div>
                                        ...
                                        <td colspan="6">
                                            <div
                                                ...
                                                <div class="text-center">
                                                    ...
                                                    <span class="text-muted">Loading noc notices...</span>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    @forelse($datas as $index => $data)
                                        <tr wire:loading.remove>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <img class="img-fluid rounded shadow-sm product-img"
                                                        src="{{ asset('backend/images/pdf.png') }}" alt="Page Image"
                                                        loading="lazy">
                                                @endif
                                            </td>
                                            <td>{{ $data->title }}</td>
