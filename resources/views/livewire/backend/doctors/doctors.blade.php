                            ...
                            <table class="table table-hover align-middle ">
                                <div class="user-table-add mb-3">
                                    <div class="row g-2 align-items-center">
                                        ...
                                        <div class="col-12 col-md-8">
                                            <div class="d-flex flex-wrap align-items-center gap-2">
                                                ...
                                                <div class="d-flex flex-wrap gap-2">
                                                    <button
                                                        class="btn {{ $statusFilter === true ? 'btn-primary' : 'btn bg-success-light' }}"
                                                        wire:click="setStatusFilter(true)">
                                                        Active ({{ $activeCount }})
                                                    </button>

                                                    <button
                                                        class="btn {{ $statusFilter === false ? 'btn-primary' : 'btn bg-success-light' }}"
                                                ...
                                                <!-- Add New Button (Mobile এ নিচে থাকবে) -->
                                                <div class="d-block d-md-none">
                                                    @can('doctors.add')
                                                        <a href="/add-doctor" class="btn btn-sm btn-primary px-3 py-2" wire:navigate>
                                        ...
                                        <!-- Right Section (Only Desktop এ দেখা যাবে) -->
                                ...
                                <tbody>
                                    ...
                                    @forelse($datas as $index => $data)
                                        <tr wire:loading.remove>
                                            ...
                                            <td>
                                                <span><i class="fas fa-user-md"></i> {{ $data->name }}</span><br>
                                                ...
                                                <span><i class="fas fa-graduation-cap"></i>
                                                    {{ $data->specialization }}</span><br>
                                                <span><i class="fas fa-id-badge"></i>
                                                    {{ $data->designation }}</span><br>
                                                <span><i class="fa-regular fa-id-card"></i> ID:
                                                    {{ $data->id }}</span>
                                            </td>
                                            <td class="doctor-info-commision-td">
                                                <div class="doctor-info">
                                                    <div class="d-flex">
                                                        <span class="doctor-info-commision"><i class="fas fa-user-injured"></i>
                                                            Total Patients</span> =
                                                        <span class="text-success">{{ $data->total_patients }}</span>
                                                    </div>
                                                    <div class="d-flex">
                                                        <span class="doctor-info-commision"><i
                                            ...
                                            <td>
                                                <div
                                                    ...
                                                    <a href="{{ route('doctor.history', $data->id) }}"
                                                        class="btn btn-sm bg-success-light" wire:navigate>
                                                    ...
                                                    @can('doctors.edit')
                                                        <button
                                                            class="btn btn-sm {{ $data->is_active ? 'btn-success' : 'btn-secondary' }}"
