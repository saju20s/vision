...
{
    public $name, $gender = 'male', $age, $phone, $address;
    ...
    public function store()
    {
        try {
            ...
            $this->dispatch('toastr:success', message: 'Patient created successfully.');
    ...
    {
        return view('livewire.backend.patients.add-patient')
