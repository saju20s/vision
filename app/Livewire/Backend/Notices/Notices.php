...
class Notices extends Component
{
    ...
    public function delete()
    {
        ...
        // Dispatch Toastr success event instead of session flash
        $this->dispatch('toastr:success', message: 'Notice deleted successfully.');
    }
    ...
    public function render()
    {
        $notices = Notice::query()
            ...
            ->where('type', 'notice')->latest()->paginate(10);

        return view('livewire.backend.notices.notices', [
            'datas' => $notices,
