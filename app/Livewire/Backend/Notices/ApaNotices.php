...
class ApaNotices extends Component
{
    use WithPagination;
    ...
    public function delete()
    {
        ...
        $this->dispatch('toastr:success', message: 'APA Notice deleted successfully.');
    }
    ...
    public function render()
    {
        $notices = Notice::query()
            ...
            ->where('type', 'apa')->latest()->paginate(10);

        return view('livewire.backend.notices.apa-notices', [
            'datas' => $notices,
